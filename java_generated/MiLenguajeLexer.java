...
public class MiLenguajeLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"INICIO", "FIN", "ENTERO", "DECIMAL", "CADENA", "BOOLEANO", "SI", "SINO", 
			"MIENTRAS", "LEER", "ESCRIBIR", "FUNCION", "BOOLEAN_LITERAL", "SUMA", 
			"RESTA", "MULT", "DIV", "MOD", "IGUAL", "DISTINTO", "MAYOR", "MENOR", 
			"MAYOR_IGUAL", "MENOR_IGUAL", "ASIGNACION", "PAR_IZQ", "PAR_DER", "LLAVE_IZQ", 
